...
export type EIDT<T extends EntityCommonBase<any>> = T extends EntityCommonBase<infer U> ? U : T;

export abstract class EntityCommonBase<IdType extends AbstractValueObject<IdType>> {
  public id?: IdType;
